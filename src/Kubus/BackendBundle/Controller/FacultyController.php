...
use Kubus\BackendBundle\Entity\Faculty;
use Kubus\BackendBundle\Form\FacultyType;
...
class FacultyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KubusBackendBundle:Faculty')->findAll();

        return $this->render('KubusBackendBundle:Faculty:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KubusBackendBundle:Faculty:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KubusBackendBundle:Faculty')->find($id);
        ...
        return $this->render('KubusBackendBundle:Faculty:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KubusBackendBundle:Faculty:edit.html.twig', array(
            'entity'      => $entity,
