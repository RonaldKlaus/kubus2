...
use Kubus\BackendBundle\Entity\Application;
use Kubus\BackendBundle\Form\ApplicationType;
...
class ApplicationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KubusBackendBundle:Application')->findAll();

        return $this->render('KubusBackendBundle:Application:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KubusBackendBundle:Application:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KubusBackendBundle:Application')->find($id);
        ...
        return $this->render('KubusBackendBundle:Application:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KubusBackendBundle:Application:edit.html.twig', array(
            'entity'      => $entity,
