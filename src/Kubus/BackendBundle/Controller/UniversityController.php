...
use Kubus\BackendBundle\Entity\University;
use Kubus\BackendBundle\Form\UniversityType;
...
class UniversityController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KubusBackendBundle:University')->findAll();

        return $this->render('KubusBackendBundle:University:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KubusBackendBundle:University:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KubusBackendBundle:University')->find($id);
        ...
        return $this->render('KubusBackendBundle:University:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KubusBackendBundle:University:edit.html.twig', array(
            'entity'      => $entity,
