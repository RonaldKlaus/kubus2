...
use Kubus\BackendBundle\Entity\Manager;
use Kubus\BackendBundle\Form\ManagerType;
...
class ManagerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KubusBackendBundle:Manager')->findAll();

        return $this->render('KubusBackendBundle:Manager:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KubusBackendBundle:Manager:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KubusBackendBundle:Manager')->find($id);
        ...
        return $this->render('KubusBackendBundle:Manager:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KubusBackendBundle:Manager:edit.html.twig', array(
            'entity'      => $entity,
    ...
    /**
    * Creates a form to edit a Manager entity.
    *
    * @param Manager $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
