...
use Kubus\BackendBundle\Entity\Message;
use Kubus\BackendBundle\Form\MessageType;
...
class MessageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KubusBackendBundle:Message')->findAll();

        return $this->render('KubusBackendBundle:Message:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KubusBackendBundle:Message:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KubusBackendBundle:Message')->find($id);
        ...
        return $this->render('KubusBackendBundle:Message:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KubusBackendBundle:Message:edit.html.twig', array(
            'entity'      => $entity,
