...
use Kubus\BackendBundle\Entity\Mail;
use Kubus\BackendBundle\Form\MailType;
...
class MailController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('KubusBackendBundle:Mail')->findAll();

        return $this->render('KubusBackendBundle:Mail:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('KubusBackendBundle:Mail:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('KubusBackendBundle:Mail')->find($id);
        ...
        return $this->render('KubusBackendBundle:Mail:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('KubusBackendBundle:Mail:edit.html.twig', array(
            'entity'      => $entity,
