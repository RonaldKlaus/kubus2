...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // kubus_backend_homepage
        if (0 === strpos($pathinfo, '/backend/hello') && preg_match('#^/backend/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'kubus_backend_homepage')), array (  '_controller' => 'Kubus\\BackendBundle\\Controller\\DefaultController::indexAction',));
        }
